...
@section('title', '機械編集 | 加工機工具管理システム')
...
@section('content')
    ...
    <div class="form-card">
        ...
        <form action="{{ route('admin.machines.update', $machine) }}" method="POST" class="form">
            @csrf
            @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input
                            ...
                            id="machine_number"
                            name="machine_number"
                            value="{{ old('machine_number', $machine->machine_number) }}"
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input
                            ...
                            value="{{ old('magazine_capacity', $machine->magazine_capacity) }}"
                            placeholder="例：20"
                            min="1"
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <select id="is_active" name="is_active" class="{{ $errors->has('is_active') ? 'is-invalid' : '' }}">
                            <option value="1" {{ old('is_active', $machine->is_active ? '1' : '0') === '1' ? 'selected' : '' }}>使用中</option>
                            <option value="0" {{ old('is_active', $machine->is_active ? '1' : '0') === '0' ? 'selected' : '' }}>停止中</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                >{{ old('note', $machine->note) }}</textarea>
            </div>
