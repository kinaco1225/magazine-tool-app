...
'passkey.confirm-options','passkey.confirm','passkey.registration-options','passkey.store','passkey.destroy','lp','admin.dashboard','admin.inventory.index',
'admin.inventory.update','admin.inventory.updateReorderPoint','admin.inventory.toggleManagesStock','admin.users.index','admin.users.create',
'admin.users.store','admin.users.edit','admin.users.update','admin.users.destroy','admin.tools.index',
'admin.tools.category','admin.tools.create','admin.tools.store','admin.tools.edit','admin.tools.update',
'admin.tools.destroy','admin.tools.orders.store','admin.tools.orders.receive','admin.tool-categories.create','admin.tool-categories.store',
'admin.tool-categories.edit','admin.tool-categories.update','admin.tool-categories.destroy','admin.magazines.index','admin.magazines.show',
'admin.magazines.showPot','admin.magazines.createPot','admin.magazines.storePot','admin.magazines.editPot','admin.magazines.updatePot',
'admin.magazines.destroyPot','admin.magazines.destroyPotWithTools','admin.magazines.disablePot','admin.magazines.enablePot','admin.standby.index',
'admin.standby.create','admin.standby.store','admin.standby.destroy','admin.standby.assign','admin.machines.index',
'admin.machines.create','admin.machines.store','admin.machines.edit','admin.machines.update','admin.machines.destroy',
'storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'admin.dashboard','admin.inventory.index','admin.machines.create','admin.machines.edit','admin.machines.index',
'admin.magazines.index','admin.magazines.pot_form','admin.magazines.pot_show','admin.magazines.show','admin.standby.form',
'admin.standby.index','admin.tool_categories.create','admin.tool_categories.edit','admin.tools.category','admin.tools.create',
'admin.tools.edit','admin.tools.index','admin.users.create','admin.users.edit','admin.users.index',
'auth.login','auth.passwords.email','auth.passwords.reset','auth.register','layouts.app',
'lp.index','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'validation.custom.attribute-name.rule-name','validation.attributes.email','validation.attributes.password','validation.attributes.name','validation.attributes.company_name',
